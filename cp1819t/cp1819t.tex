...
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\Varid{mirror}\mathrel{=}\cata{\alt{\Conid{Num}}{\Varid{g2}}}{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
...
\\
\>[B]{}\Varid{conta}\mathrel{=}\cata{(\Varid{sum}\comp \map \;(\alt{\underline{\mathrm{1}}}{\Varid{id}}\comp \p2))}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
O que é para fazer:
\begin{enumerate}
\item Definir as funções \ensuremath{\Varid{outFS}}, \ensuremath{\Varid{baseFS}}, \ensuremath{\cata{\cdot }}, \ensuremath{\ana{\cdot }} e \ensuremath{\cata{\cdot }}.

\item Apresentar, no relatório, o diagrama de \ensuremath{\cata{\cdot }}.
...
\\
\>[B]{}\Varid{prop\char95 check}\mathrel{=}\Varid{check}\comp \cata{(\Varid{inFS}\comp \Varid{reverse})}\equiv\Varid{check}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
  \end{propriedade}  
...
\>[14]{}\mathrel{=}\ana{(\Varid{prepOut}\comp (\Varid{id}\times\Varid{proc})\comp \Varid{prepIn})}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
...
\\
\>[B]{}\Varid{checkFiles}\mathrel{=}\cata{(\uncurry{(\mathrel{\wedge})}\comp \conj{\Varid{f}}{\Varid{g}})}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{12}{}\<[12]%
...
\\
\>[B]{}\Varid{inExpr}\mathrel{=}{}\<[11]%
\>[11]{}\alt{\Conid{Num}}{\uncurry{(\uncurry{\cdot }\comp \Varid{flip}\;\Conid{Bop})}}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{outExpr}\;(\Conid{Bop}\;\Varid{a}\;\Varid{x}\;\Varid{b})\mathrel{=}i_2\;(\Varid{x},(\Varid{a},\Varid{b})){}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment Catamorfismo de Expr}{}\<[E]%
\\
\>[B]{}\cata{\Varid{g}}\mathrel{=}\Varid{g}\comp \Varid{recExpr}\;\cata{\Varid{g}}\comp \Varid{outExpr}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment Anamorfismo de Expr}{}\<[E]%
\\
\>[B]{}\ana{\Varid{g}}\mathrel{=}\Varid{inExpr}\comp \Varid{recExpr}\;\ana{\Varid{g}}\comp \Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment Hilomorfismo de Expr}{}\<[E]%
\\
\>[B]{}\cata{\Varid{f}}\;\Varid{g}\mathrel{=}\cata{\Varid{f}}\comp \ana{\Varid{g}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{21}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{calcAux}\mathbin{::}(\Conid{Op},(\Conid{Int},\Conid{Int}))\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{calcAux}\;(\Varid{x},(\Varid{a},\Varid{b}))\mid \Varid{x}\equiv \Conid{Op}\;\text{\ttfamily \char34 +\char34}\mathrel{=}\Varid{a}\mathbin{+}\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\mid \Varid{x}\equiv \Conid{Op}\;\text{\ttfamily \char34 *\char34}\mathrel{=}\Varid{a}\mathbin{*}\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\mid \Varid{x}\equiv \Conid{Op}\;\text{\ttfamily \char34 -\char34}\mathrel{=}\Varid{a}\mathbin{-}\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\mid \Varid{otherwise}\mathrel{=}\Varid{a}\div \Varid{b}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcula}\mathbin{::}\Conid{Expr}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{calcula}\mathrel{=}\cata{\alt{\Varid{id}}{\Varid{calcAux}}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{compile}\mathrel{=}\cata{\alt{\Varid{g1}}{\Varid{g2}}}\comp \p1\comp \Varid{head}\comp \Varid{readExp}{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{g1}\;\Varid{a}\mathrel{=}[\mskip1.5mu \text{\ttfamily \char34 PUSH~\char34}\plus \Varid{show}\;\Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{g2}\;(\Varid{x},(\Varid{a},\Varid{b}))\mid \Varid{x}\equiv \Conid{Op}\;\text{\ttfamily \char34 +\char34}\mathrel{=}\Varid{a}\plus \Varid{b}\plus [\mskip1.5mu \text{\ttfamily \char34 ADD\char34}\mskip1.5mu]{}\<[E]%
\\
\>[17]{}\hsindent{14}{}\<[31]%
\>[31]{}\mid \Varid{x}\equiv \Conid{Op}\;\text{\ttfamily \char34 *\char34}\mathrel{=}\Varid{a}\plus \Varid{b}\plus [\mskip1.5mu \text{\ttfamily \char34 MUL\char34}\mskip1.5mu]{}\<[E]%
\\
\>[17]{}\hsindent{14}{}\<[31]%
\>[31]{}\mid \Varid{x}\equiv \Conid{Op}\;\text{\ttfamily \char34 -\char34}\mathrel{=}\Varid{a}\plus \Varid{b}\plus [\mskip1.5mu \text{\ttfamily \char34 SUB\char34}\mskip1.5mu]{}\<[E]%
\\
\>[17]{}\hsindent{14}{}\<[31]%
\>[31]{}\mid \Varid{otherwise}\mathrel{=}\Varid{a}\plus \Varid{b}\plus [\mskip1.5mu \text{\ttfamily \char34 DIV\char34}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{show'}\mathrel{=}\cata{\alt{\Varid{g1}}{\Varid{g2}}}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{g1}\;\Varid{a}\mathrel{=}\Varid{showAux}\;\Varid{a}{}\<[E]%
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}\Varid{g2}\;(\Conid{Op}\;\Varid{a},(\Varid{x},\Varid{y}))\mid \length \;(\Varid{x})\mathbin{>}\mathrm{1}\mathrel{=}\text{\ttfamily \char34 (\char34}\plus \Varid{x}\plus \text{\ttfamily \char34 )\char34}\plus \Varid{a}\plus \Varid{y}{}\<[E]%
\\
\>[15]{}\hsindent{16}{}\<[31]%
\>[31]{}\mid \length \;(\Varid{y})\mathbin{>}\mathrm{1}\mathrel{=}\Varid{x}\plus \Varid{a}\plus \text{\ttfamily \char34 (\char34}\plus \Varid{y}\plus \text{\ttfamily \char34 )\char34}{}\<[E]%
\\
\>[15]{}\hsindent{16}{}\<[31]%
\>[31]{}\mid \Varid{otherwise}\mathrel{=}\text{\ttfamily \char34 (~\char34}\plus \Varid{x}\plus \Varid{a}\plus \Varid{y}\plus \text{\ttfamily \char34 ~)\char34}{}\<[E]%
\\
\>[B]{}\Varid{showAux}\mathbin{::}\Conid{Int}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{showAux}\;\Varid{a}\mid \Varid{a}\mathbin{<}\mathrm{0}\mathrel{=}\text{\ttfamily \char34 (\char34}\plus \Varid{show}\;\Varid{a}\plus \text{\ttfamily \char34 )\char34}{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mid \Varid{otherwise}\mathrel{=}\Varid{show}\;\Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{inL2D}\mathrel{=}\alt{\Conid{Unid}}{\Varid{comp}}\;\mathbf{where}\;\Varid{comp}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}\Conid{Comp}\;\Varid{a}\;\Varid{b}\;\Varid{c}{}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment Functor}{}\<[E]%
\\
\>[B]{}\Varid{recL2D}\;\Varid{f}\mathrel{=}\Varid{id}+\Varid{id}\times(\Varid{f}\times\Varid{f}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment Catamorfismo}{}\<[E]%
\\
\>[B]{}\cata{\Varid{g}}\mathrel{=}\Varid{g}\comp \Varid{recL2D}\;\cata{\Varid{g}}\comp \Varid{outL2D}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment Anamorfismo}{}\<[E]%
\\
\>[B]{}\ana{\Varid{g}}\mathrel{=}\Varid{inL2D}\comp \Varid{recL2D}\;\ana{\Varid{g}}\comp \Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment Hylomorfismo}{}\<[E]%
\\
\>[B]{}\cata{\Varid{g}}\;\Varid{h}\mathrel{=}\cata{\Varid{g}}\comp \ana{\Varid{h}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{collectLeafs}\mathrel{=}\cata{\alt{\Varid{g1}}{\Varid{g2}}}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathbf{where}\;\Varid{g1}\;\Varid{a}\mathrel{=}[\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[17]{}\hsindent{6}{}\<[23]%
\>[23]{}\Varid{g2}\;(\Varid{b},(\Varid{a},\Varid{c}))\mathrel{=}\Varid{a}\plus \Varid{c}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Conid{Caixa}\mathrel{=}((\Conid{Int},\Conid{Int}),(\Conid{Texto},\Conid{\Conid{G}.Color})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{dimen}\mathrel{=}\cata{\alt{\Varid{g1}}{\Varid{g2}}}{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{g1}\;\Varid{a}\mathrel{=}\Varid{int2float}\;(\p1\;\Varid{a}){}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{g2}\;(\Varid{t},(\Varid{b},\Varid{c}))\mathrel{=}\Varid{compareDimen}\;\Varid{t}\;\Varid{b}\;\Varid{c}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{17}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{compareDimen}\mathbin{::}\Conid{Tipo}\to (\Conid{Float},\Conid{Float})\to (\Conid{Float},\Conid{Float})\to (\Conid{Float},\Conid{Float}){}\<[E]%
\\
\>[B]{}\Varid{compareDimen}\;\Conid{V}\;{}\<[17]%
\>[17]{}(\Varid{a},\Varid{b})\;(\Varid{x},\Varid{y})\mathrel{=}\mathbf{if}\;(\Varid{a}\mathbin{>}\Varid{x})\;\mathbf{then}\;(\Varid{a},\Varid{b}\mathbin{+}\Varid{y})\;\mathbf{else}\;(\Varid{x},\Varid{b}\mathbin{+}\Varid{y}){}\<[E]%
\\
\>[B]{}\Varid{compareDimen}\;\Conid{Vd}\;(\Varid{a},\Varid{b})\;(\Varid{x},\Varid{y})\mathrel{=}\mathbf{if}\;(\Varid{a}\mathbin{>}\Varid{x})\;\mathbf{then}\;(\Varid{a},\Varid{b}\mathbin{+}\Varid{y})\;\mathbf{else}\;(\Varid{x},\Varid{b}\mathbin{+}\Varid{y}){}\<[E]%
\\
\>[B]{}\Varid{compareDimen}\;\Conid{Ve}\;(\Varid{a},\Varid{b})\;(\Varid{x},\Varid{y})\mathrel{=}\mathbf{if}\;(\Varid{a}\mathbin{>}\Varid{x})\;\mathbf{then}\;(\Varid{a},\Varid{b}\mathbin{+}\Varid{y})\;\mathbf{else}\;(\Varid{x},\Varid{b}\mathbin{+}\Varid{y}){}\<[E]%
\\
\>[B]{}\Varid{compareDimen}\;\Conid{H}\;{}\<[17]%
\>[17]{}(\Varid{a},\Varid{b})\;(\Varid{x},\Varid{y})\mathrel{=}\mathbf{if}\;(\Varid{b}\mathbin{>}\Varid{y})\;\mathbf{then}\;(\Varid{a}\mathbin{+}\Varid{x},\Varid{b})\;\mathbf{else}\;(\Varid{a}\mathbin{+}\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\Varid{compareDimen}\;\Conid{Hb}\;(\Varid{a},\Varid{b})\;(\Varid{x},\Varid{y})\mathrel{=}\mathbf{if}\;(\Varid{b}\mathbin{>}\Varid{y})\;\mathbf{then}\;(\Varid{a}\mathbin{+}\Varid{x},\Varid{b})\;\mathbf{else}\;(\Varid{a}\mathbin{+}\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\Varid{compareDimen}\;\Conid{Ht}\;(\Varid{a},\Varid{b})\;(\Varid{x},\Varid{y})\mathrel{=}\mathbf{if}\;(\Varid{b}\mathbin{>}\Varid{y})\;\mathbf{then}\;(\Varid{a}\mathbin{+}\Varid{x},\Varid{b})\;\mathbf{else}\;(\Varid{a}\mathbin{+}\Varid{x},\Varid{y}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{25}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{int2float}\mathbin{::}(\Conid{Int},\Conid{Int})\to (\Conid{Float},\Conid{Float}){}\<[E]%
\\
\>[B]{}\Varid{int2float}\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{19}{}\<[19]%
\>[19]{}\mathbf{where}\;\Varid{x}\mathrel{=}\Varid{fromIntegral}\;\Varid{a}\mathbin{::}\Conid{Float}{}\<[E]%
\\
\>[19]{}\hsindent{6}{}\<[25]%
\>[25]{}\Varid{y}\mathrel{=}\Varid{fromIntegral}\;\Varid{b}\mathbin{::}\Conid{Float}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{calcOrigins}\;(\Varid{c},\Varid{o})\mathrel{=}\ana{\Varid{g}}\;(\Varid{o},\Varid{c}){}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\mathbf{where}\;\Varid{g}\;(\Varid{o},(\Conid{Unid}\;\Varid{a}))\mathrel{=}i_1\;(\Varid{a},\Varid{o}){}\<[E]%
\\
\>[23]{}\hsindent{6}{}\<[29]%
\>[29]{}\Varid{g}\;(\Varid{o},(\Conid{Comp}\;\Varid{a}\;\Varid{b}\;\Varid{c}))\mathrel{=}i_2\;((),((\Varid{o},\Varid{b}),(\Varid{aux}\;\Varid{a},\Varid{c}))){}\<[E]%
\\
\>[29]{}\hsindent{8}{}\<[37]%
\>[37]{}\mathbf{where}\;\Varid{aux}\;\Conid{V}{}\<[50]%
\>[50]{}\mathrel{=}\Varid{calc}\;\Varid{a}\;\Varid{z}\;\Varid{w}{}\<[E]%
\\
\>[37]{}\hsindent{6}{}\<[43]%
\>[43]{}\Varid{aux}\;\Conid{Vd}\mathrel{=}\Varid{calc}\;\Varid{a}\;\Varid{z}\;\Varid{w}{}\<[E]%
\\
\>[37]{}\hsindent{6}{}\<[43]%
\>[43]{}\Varid{aux}\;\Conid{Ht}\mathrel{=}\Varid{calc}\;\Varid{a}\;\Varid{z}\;\Varid{w}{}\<[E]%
\\
\>[37]{}\hsindent{6}{}\<[43]%
\>[43]{}\Varid{aux}\;\Conid{H}{}\<[50]%
\>[50]{}\mid \Varid{o}\equiv (\mathrm{0.0},\mathrm{0.0})\mathrel{=}\Varid{calc}\;\Varid{a}\;\Varid{z}\;(\mathrm{0.0},\p2\;\Varid{w}){}\<[E]%
\\
\>[50]{}\mid \Varid{otherwise}{}\<[65]%
\>[65]{}\mathrel{=}\Varid{calc}\;\Varid{a}\;\Varid{o}\;\Varid{z}{}\<[E]%
\\
\>[37]{}\hsindent{6}{}\<[43]%
\>[43]{}\Varid{aux}\;\anonymous {}\<[50]%
\>[50]{}\mathrel{=}\Varid{calc}\;\Varid{a}\;\Varid{o}\;\Varid{z}{}\<[E]%
\\
\>[37]{}\hsindent{6}{}\<[43]%
\>[43]{}\Varid{z}\mathrel{=}{}\<[48]%
\>[48]{}\Varid{dimen}\;\Varid{b}{}\<[E]%
\\
\>[37]{}\hsindent{6}{}\<[43]%
\>[43]{}\Varid{w}\mathrel{=}{}\<[48]%
\>[48]{}\Varid{dimen}\;\Varid{c}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{calc}\;\Conid{V}\;(\Varid{o1},\Varid{o2})\;(\Varid{x},\Varid{y})\mathrel{=}(\Varid{n1},\Varid{n2}){}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mathbf{where}\;\Varid{n1}\mathrel{=}(\Varid{o1}\mathbin{/}\mathrm{2})\mathbin{-}(\Varid{x}\mathbin{/}\mathrm{2}){}\<[E]%
\\
\>[25]{}\hsindent{6}{}\<[31]%
\>[31]{}\Varid{n2}\mathrel{=}\Varid{o2}{}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{Vd}\;(\Varid{o1},\Varid{o2})\;(\Varid{x},\Varid{y})\mathrel{=}(\Varid{n1},\Varid{n2}){}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mathbf{where}\;\Varid{n1}\mathrel{=}\Varid{o2}\mathbin{-}\Varid{y}{}\<[E]%
\\
\>[25]{}\hsindent{6}{}\<[31]%
\>[31]{}\Varid{n2}\mathrel{=}\Varid{o2}{}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{Ve}\;(\Varid{o1},\Varid{o2})\;(\Varid{x},\Varid{y})\mathrel{=}(\Varid{n1},\Varid{n2}){}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mathbf{where}\;\Varid{n1}\mathrel{=}\Varid{o1}{}\<[E]%
\\
\>[25]{}\hsindent{6}{}\<[31]%
\>[31]{}\Varid{n2}\mathrel{=}\Varid{o2}\mathbin{+}\Varid{y}{}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{H}\;(\Varid{o1},\Varid{o2})\;(\Varid{x},\Varid{y})\mid \Varid{x}\equiv \mathrm{0.0}{}\<[43]%
\>[43]{}\mathrel{=}(\Varid{o1},(\Varid{o2}\mathbin{/}\mathrm{2})\mathbin{-}(\Varid{y}\mathbin{/}\mathrm{2})){}\<[E]%
\\
\>[B]{}\hsindent{22}{}\<[22]%
\>[22]{}\mid (\Varid{o1},\Varid{o2})\equiv (\mathrm{0.0},\mathrm{0.0})\mathrel{=}(\Varid{x},\Varid{o2}\mathbin{+}(\Varid{y}\mathbin{/}\mathrm{2})){}\<[E]%
\\
\>[B]{}\hsindent{22}{}\<[22]%
\>[22]{}\mid \Varid{otherwise}{}\<[43]%
\>[43]{}\mathrel{=}(\Varid{o1}\mathbin{+}\Varid{x},\Varid{o2}\mathbin{+}(\Varid{y}\mathbin{/}\mathrm{2})){}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{Hb}\;(\Varid{o1},\Varid{o2})\;(\Varid{x},\Varid{y})\mathrel{=}(\Varid{n1},\Varid{n2}){}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mathbf{where}\;\Varid{n1}\mathrel{=}\Varid{x}{}\<[E]%
\\
\>[25]{}\hsindent{6}{}\<[31]%
\>[31]{}\Varid{n2}\mathrel{=}\Varid{o2}{}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{Ht}\;(\Varid{o1},\Varid{o2})\;(\Varid{x},\Varid{y})\mathrel{=}(\Varid{n1},\Varid{n2}){}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mathbf{where}\;\Varid{n1}\mathrel{=}\Varid{o1}{}\<[E]%
\\
...
\>[B]{}\Varid{agrup\char95 caixas}\mathbin{::}\Conid{X}\;(\Conid{Caixa},\Conid{Origem})\;()\to \Conid{Fig}{}\<[E]%
\\
\>[B]{}\Varid{agrup\char95 caixas}\mathrel{=}\cata{\alt{\Varid{g1}}{\Varid{g2}}}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathbf{where}\;\Varid{g1}\;(\Varid{a},\Varid{b})\mathrel{=}[\mskip1.5mu (\Varid{b},\Varid{a})\mskip1.5mu]{}\<[E]%
\\
\>[17]{}\hsindent{6}{}\<[23]%
\>[23]{}\Varid{g2}\;(\Varid{b},(\Varid{a},\Varid{c}))\mathrel{=}\Varid{a}\plus \Varid{c}{}\<[E]%
\ColumnHook
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{caixas2Fig}\mathbin{::}((\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}),\Conid{Origem})\to \Conid{Fig}{}\<[E]%
\\
\>[B]{}\Varid{caixas2Fig}\mathrel{=}\Varid{agrup\char95 caixas}\comp \Varid{calcOrigins}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[B]{}\Varid{mostra\char95 caixas}\mathbin{::}(\Conid{L2D},\Conid{Origem})\to \fun{IO}\;(){}\<[E]%
\\
\>[B]{}\Varid{mostra\char95 caixas}\mathrel{=}\Varid{display}\comp \Varid{\Conid{G}.pictures}\comp \Varid{fig2Pictures}\comp \Varid{caixas2Fig}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{fig2Pictures}\mathbin{::}\Conid{Fig}\to [\mskip1.5mu \Conid{\Conid{G}.Picture}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{fig2Pictures}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{fig2Pictures}\;((\Varid{o},\Varid{c})\mathbin{:}\Varid{t})\mathrel{=}(\Varid{crCaixaAux}\;\Varid{o}\;(\p1\;\Varid{c})\;(\p2\;\Varid{c}))\mathbin{:}(\Varid{fig2Pictures}\;\Varid{t}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{31}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{crCaixaAux}\mathbin{::}\Conid{Origem}\to (\Conid{Int},\Conid{Int})\to (\Conid{String},\Conid{\Conid{G}.Color})\to \Conid{\Conid{G}.Picture}{}\<[E]%
\\
\>[B]{}\Varid{crCaixaAux}\;\Varid{o}\;(\Varid{x},\Varid{y})\;(\Varid{n},\Varid{c})\mathrel{=}\Varid{crCaixa}\;\Varid{o}\;\Varid{a}\;\Varid{b}\;\Varid{n}\;\Varid{c}{}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mathbf{where}\;\Varid{a}\mathrel{=}\Varid{fromIntegral}\;\Varid{x}\mathbin{::}\Conid{Float}{}\<[E]%
\\
\>[25]{}\hsindent{6}{}\<[31]%
\>[31]{}\Varid{b}\mathrel{=}\Varid{fromIntegral}\;\Varid{y}\mathbin{::}\Conid{Float}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{caixasAndOrigin2Pict}\mathrel{=}\Varid{\Conid{G}.pictures}\comp \Varid{fig2Pictures}\comp \Varid{caixas2Fig}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{s}\;\Varid{n}\mathrel{=}\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{3}{}\<[E]%
\\
\>[B]{}\Varid{s}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{3})\mathbin{+}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{s}\;\mathrm{0}\mathrel{=}\mathrm{3}{}\<[E]%
\\
\>[B]{}\Varid{v}\;\Varid{n}\mathrel{=}\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{4}{}\<[E]%
\\
\>[B]{}\Varid{v}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{4})\mathbin{+}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{v}\;\mathrm{0}\mathrel{=}\mathrm{4}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{loop}\;(\Varid{cs},\Varid{h},\Varid{s},\Varid{v})\mathrel{=}(\Varid{h}\mathbin{+}\Varid{cs},\mathbin{-}\Varid{x}\mathbin{\uparrow}\mathrm{2}\mathbin{/}(\Varid{s}\mathbin{*}\Varid{v})\mathbin{*}\Varid{h},\mathrm{2}\mathbin{+}\Varid{s},\mathrm{2}\mathbin{+}\Varid{v}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{init}\mathrel{=}(\mathrm{1},(\mathbin{-}\Varid{x}\mathbin{\uparrow}\mathrm{2})\mathbin{/}\mathrm{2},\mathrm{3},\mathrm{4}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{prj}\;(\Varid{cs},\Varid{h},\Varid{s},\Varid{v})\mathrel{=}\Varid{cs}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[B]{}\mbox{\onelinecomment Catamorfismo}{}\<[E]%
\\
\>[B]{}\cata{\cdot }\mathbin{::}([\mskip1.5mu (\Varid{a},\Varid{b}+\Varid{c})\mskip1.5mu]\to \Varid{c})\to \Conid{FS}\;\Varid{a}\;\Varid{b}\to \Varid{c}{}\<[E]%
\\
\>[B]{}\cata{\Varid{g}}\mathrel{=}\Varid{g}\comp \Varid{recFS}\;\cata{\Varid{g}}\comp \Varid{outFS}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment Anamorfismo}{}\<[E]%
\\
\>[B]{}\ana{\cdot }\mathbin{::}(\Varid{c}\to [\mskip1.5mu (\Varid{a},\Varid{b}+\Varid{c})\mskip1.5mu])\to \Varid{c}\to \Conid{FS}\;\Varid{a}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\ana{\Varid{g}}\mathrel{=}\Varid{inFS}\comp \Varid{recFS}\;\ana{\Varid{g}}\comp \Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment Hylomorfismo}{}\<[E]%
\\
\>[B]{}\cata{\Varid{g}}\;\Varid{h}\mathrel{=}\cata{\Varid{g}}\comp \ana{\Varid{h}}{}\<[E]%
...
\xymatrix@C=6cm{
    ...
    \ar@{}[r]|-{\cong}
&
    \ensuremath{(\Conid{X}\times(\Conid{A}\mathbin{+}\Conid{FS}\;\Varid{a}\;\Varid{b}))\mathbin{*}}
    \ar[d]^{\ensuremath{\map \;(\Varid{id}\times(\Varid{id}\mathbin{+}\cata{\Varid{g}})}}
    \ar@/^1pc/[l]^{\ensuremath{\Varid{inFS}}}
\\
     \ensuremath{\Conid{B}}
&
     \ensuremath{(\Conid{X}\times(\Conid{A}\mathbin{+}\Conid{B}))\mathbin{*}}
      \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\column{46}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{checkRep}\mathbin{::}\Conid{Eq}\;\Varid{a}\Rightarrow [\mskip1.5mu \Varid{a}\mskip1.5mu]\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{checkRep}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{checkRep}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}(\neg \;(\Varid{elem}\;\Varid{h}\;\Varid{t}))\mathrel{\wedge}(\Varid{checkRep}\;\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{check}\mathbin{::}(\Conid{Eq}\;\Varid{a})\Rightarrow \Conid{FS}\;\Varid{a}\;\Varid{b}\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{check}\mathrel{=}\cata{(\Varid{checAux})}{}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\mathbf{where}\;\Varid{checAux}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[15]{}\hsindent{6}{}\<[21]%
\>[21]{}\Varid{checAux}\;((\Varid{a},i_1\;\Varid{b})\mathbin{:}\Varid{t})\mid (\Varid{checkRep}\;(\map \;\p1\;((\Varid{a},i_1\;\Varid{b})\mathbin{:}\Varid{t})))\mathrel{=}\Conid{True}\mathrel{\wedge}(\Varid{checAux}\;\Varid{t}){}\<[E]%
\\
\>[21]{}\hsindent{24}{}\<[45]%
\>[45]{}\mid \Varid{otherwise}\mathrel{=}\Conid{False}{}\<[E]%
\\
\>[15]{}\hsindent{6}{}\<[21]%
\>[21]{}\Varid{checAux}\;((\Varid{a},i_2\;\Varid{b})\mathbin{:}\Varid{t})\mid \Varid{b}\mathrel{=}\Conid{True}\mathrel{\wedge}\Varid{checAux}\;\Varid{t}{}\<[E]%
\\
\>[21]{}\hsindent{25}{}\<[46]%
\>[46]{}\mid \Varid{otherwise}\mathrel{=}\Conid{False}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{43}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{addToTuple}\mathbin{::}\Varid{a}\to [\mskip1.5mu ([\mskip1.5mu \Varid{a}\mskip1.5mu],\Varid{b})\mskip1.5mu]\to [\mskip1.5mu ([\mskip1.5mu \Varid{a}\mskip1.5mu],\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{addToTuple}\;\anonymous \;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{addToTuple}\;\Varid{x}\;(([\mskip1.5mu \mskip1.5mu],\anonymous )\mathbin{:}\Varid{t})\mathrel{=}\Varid{addToTuple}\;\Varid{x}\;\Varid{t}{}\<[E]%
\\
\>[B]{}\Varid{addToTuple}\;\Varid{x}\;((\Varid{l},\Varid{a})\mathbin{:}\Varid{t}){}\<[25]%
\>[25]{}\mathrel{=}((\Varid{x}\mathbin{:}\Varid{l}),\Varid{a})\mathbin{:}(\Varid{addToTuple}\;\Varid{x}\;\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{tar}\mathbin{::}(\Conid{Eq}\;\Varid{a})\Rightarrow \Conid{FS}\;\Varid{a}\;\Varid{b}\to [\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{tar}\mathrel{=}\cata{(\Varid{tarAux})}{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mathbf{where}\;\Varid{tarAux}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[13]{}\hsindent{6}{}\<[19]%
\>[19]{}\Varid{tarAux}\;((\Varid{a},i_1\;\Varid{b})\mathbin{:}\Varid{t}){}\<[43]%
\>[43]{}\mathrel{=}([\mskip1.5mu \Varid{a}\mskip1.5mu],\Varid{b})\mathbin{:}(\Varid{tarAux}\;\Varid{t}){}\<[E]%
\\
\>[13]{}\hsindent{6}{}\<[19]%
\>[19]{}\Varid{tarAux}\;((\Varid{a},i_2\;\Varid{b})\mathbin{:}\Varid{t})\mathrel{=}(\Varid{addToTuple}\;\Varid{a}\;\Varid{b})\plus (\Varid{tarAux}\;\Varid{t}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{untar}\mathrel{=}\Varid{joinDupDirs}\comp \ana{(\Varid{untarAux})}{}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\mathbf{where}\;\Varid{untarAux}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[15]{}\hsindent{6}{}\<[21]%
\>[21]{}\Varid{untarAux}\;(((\Varid{p}\mathbin{:}\Varid{ps}),\Varid{b})\mathbin{:}\Varid{rl})\mid (\Varid{ps}\equiv [\mskip1.5mu \mskip1.5mu])\mathrel{=}[\mskip1.5mu (\Varid{p},i_1\;\Varid{b})\mskip1.5mu]\plus \Varid{untarAux}\;\Varid{rl}{}\<[E]%
\\
\>[21]{}\hsindent{25}{}\<[46]%
\>[46]{}\mid \Varid{otherwise}{}\<[59]%
\>[59]{}\mathrel{=}[\mskip1.5mu (\Varid{p},i_2\;[\mskip1.5mu (\Varid{ps},\Varid{b})\mskip1.5mu])\mskip1.5mu]\plus \Varid{untarAux}\;\Varid{rl}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{59}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{addToList}\mathbin{::}\Varid{a}\to [\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{addToList}\;{}\<[12]%
\>[12]{}\anonymous \;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{addToList}\;\Varid{x}\;([\mskip1.5mu \mskip1.5mu]\mathbin{:}\Varid{t})\mathrel{=}(\Varid{addToList}\;\Varid{x}\;\Varid{t}){}\<[E]%
\\
\>[B]{}\Varid{addToList}\;\Varid{x}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}(\Varid{x}\mathbin{:}\Varid{h})\mathbin{:}(\Varid{addToList}\;\Varid{x}\;\Varid{t}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{find}\;\Varid{a}\mathrel{=}\cata{(\Varid{findAux}\;\Varid{a})}{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{findAux}\;\Varid{file}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{findAux}\;\Varid{file}\;((\Varid{a},i_1\;\Varid{b})\mathbin{:}\Varid{t})\mid (\Varid{file}\equiv \Varid{a})\mathrel{=}([\mskip1.5mu \Varid{a}\mskip1.5mu])\mathbin{:}(\Varid{findAux}\;\Varid{file}\;\Varid{t}){}\<[E]%
\\
\>[17]{}\hsindent{28}{}\<[45]%
\>[45]{}\mid \Varid{otherwise}{}\<[59]%
\>[59]{}\mathrel{=}\Varid{findAux}\;\Varid{file}\;\Varid{t}{}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{findAux}\;\Varid{file}\;((\Varid{a},i_2\;\Varid{b})\mathbin{:}\Varid{t})\mathrel{=}(\Varid{addToList}\;\Varid{a}\;\Varid{b})\plus (\Varid{findAux}\;\Varid{file}\;\Varid{t}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
